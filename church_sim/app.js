...
function renderPagesDirectory() {
    ...
    el('pagesFigures').innerHTML = [
        ...
        card('/figures/lambda-nesting-sequence', 'Fig 9: LAMBDA Nesting', 'figure', td, 'Non-nestable LAMBDA with CALL-mediated nesting.'),
        card('/figures/lambda-calculus-mapping', 'Fig 10: Lambda Mapping', 'figure', td, 'Lambda calculus to CTMM hardware mapping.'),
        card('/figures/lambda-clamp-example', 'Fig 11: LAMBDA Clamp', 'figure', td, 'Macro-like code reuse.'),
        card('/figures/tunnel-architecture', 'Fig 12: Tunnel Architecture', 'figure', td, 'Encrypted capability tunnel between Meta Machines.'),
        card('/figures/dispatch-styles-comparison', 'Fig 13: Dispatch Styles', 'figure', td, 'Same CALL, three resolutions.'),
        card('/figures/conventional-vs-ctmm', 'Fig 14: Conventional vs CTMM', 'figure', td, 'Attack surface elimination.'),
        card('/figures/boot-sequence-state-machine', 'Fig 15: Boot Sequence', 'figure', td, '5-phase hardware initialization.'),
        card('/figures/mload-validation-pipeline', 'Fig 16: mLoad Pipeline', 'figure', td, 'Five sequential validation checks.'),
        card('/figures/mint-abstraction-nesting', 'Fig 17: Mint Abstraction', 'figure', td, 'Abstraction nesting and domain purity.'),
        card('/figures/hello-mum-tunnel', 'Fig 18: Hello Mum Tunnel', 'figure', td, 'Encrypted capability tunnel example.'),
    ].join('');
