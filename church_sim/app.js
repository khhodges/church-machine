...
function renderPagesDirectory() {
    ...
    fill('pagesSimulators',
        ...
        navCard('/ctmm/', 'CM Simulator', 'Sim-64', ts, 'Custom ISA, 64-bit Golden Tokens, namespace browser, assembly editor.'),
    ...
    fill('pagesFigures',
        ...
        card('/figures/atomic-abstraction-architecture', 'Fig 10: 7 Zeroes Architecture', 'figure', td, 'Conventional vs CM: no OS, no VM, no rings, no root, no ACLs, no MMU, no ambient authority.'),
        ...
        card('/figures/lambda-calculus-mapping', 'Fig 19: Lambda Mapping', 'figure', td, 'Lambda calculus to CM hardware mapping.'),
        ...
        card('/figures/conventional-vs-ctmm', 'Fig 23: Conventional vs CM', 'figure', td, 'Attack surface elimination.'),
