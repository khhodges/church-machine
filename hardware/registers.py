    ...
    def elaborate(self, platform):
        ...
        with m.Else():
            ...
            with m.Elif(self.m_flag_restore_en):
                m.d.sync += m_bit_regs[15].eq(self.m_flag_restore_val)

            # Single 32-bit M-bit I/O object; only its low 16 bits are state.
            with m.If(self.m_bit_device_wr_en):
                m.d.sync += m_bit_regs.eq(self.m_bit_device_word)
