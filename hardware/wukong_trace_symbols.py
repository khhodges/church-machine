...
_WUKONG_CALLHOME_FALLBACK_WORDS = (
    ...
    0x87320001, 0xB73B4001, 0xB8007FFE, 0xAF284057,
    0x8F2A0000, 0x87320001, 0xB73B4001, 0xB8007FFE,
    0xAF284055, 0x8F2A0000, 0x87320001, 0xB73B4001,
    0xB8007FFE, 0xAF28404B, 0x8F2A0000, 0x87320001,
    0xB73B4001, 0xB8007FFE, 0xAF28404F, 0x8F2A0000,
    0x87320001, 0xB73B4001, 0xB8007FFE, 0xAF28404E,
    0x8F2A0000, 0x87320001, 0xB73B4001, 0xB8007FFE,
    0xAF284047, 0x8F2A0000, 0x87320001, 0xB73B4001,
    0xB8007FFE, 0xAF28400D, 0x8F2A0000, 0x87320001,
    0xB73B4001, 0xB8007FFE, 0xAF28400A, 0x8F2A0000,
    0x87320001, 0xB73B4001, 0xB8007FFE, 0xAF18417C,
    0xAF107FFF, 0xB7114001, 0xB8807FFF, 0xB719C001,
    0xB8807FFC, 0x8F018000, 0xAF18417C, 0xAF107FFF,
    0xB7114001, 0xB8807FFF, 0xB719C001, 0xB8807FFC,
    0xBF007FBB,
)
...
def _disassemble_word(word):
    ...
    if opcode in (21, 22):
        if imm & 0x4000:
            return f"{mnemonic} DR{dst}, DR{src}, #{imm & 0x3FFF}"
        return f"{mnemonic} DR{dst}, DR{src}, DR{imm & 0xF}"
    if opcode == 23:
