...
The current hardware development and release target is the Xilinx Artix-7
XC7A100T FPGA (Wukong board). Tang Nano material is retained as a
legacy/experimental profile and is not the current release path.
