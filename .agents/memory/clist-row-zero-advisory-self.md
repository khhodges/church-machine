...
**How to apply:** Normalize symbolic SELF aliases in the common compiler/viewer path and keep them out of ordinary dependency resolution. Distinguish new C-list creation from existing concrete row-zero validation; validation may warn but must not rewrite.