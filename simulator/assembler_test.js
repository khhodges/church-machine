...
//   - the c-list slot holds a non-null, correctly-typed Golden Token GT
{
    ...
    //   resolvedCaps capability-name → nsIndex resolution: lines 1355–1374
    //   lumpWords allocation + c-list Golden Token write: lines 1376–1395
    const resolveSrc = compileLines.slice(1354, 1375).join('\n');
    const clistSrc    = compileLines.slice(1375, 1396).join('\n');
