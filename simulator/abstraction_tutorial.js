...
<div class="sr-sec-item"><span class="sr-sec-num">2</span><strong>Boot LOAD_NUC.</strong> The hardware writes <strong>CR14</strong> (code GT: slot 3, Turing X-perm — the boot code domain) and <strong>CR6</strong> (DEMO c-list GT: slot 2, Church E-perm, base = 0x400). PC is set to 0. The 3-instruction boot ROM begins executing.</div>
<div class="sr-sec-item"><span class="sr-sec-num">3</span><strong>Boot ROM executes 3 instructions.</strong> <code>LOAD CR15, CR15[0]</code> refreshes the Namespace cap. <code>CHANGE CR12, CR15, #1</code> loads Boot.Thread (slot 1), establishing CR0\u2013CR11 including the Application LUMP E-GT in CR0. <code>CALL CR0, CR0</code> enters the IDE-configured Application LUMP.</div>
