...
const API_DATA = [
    ...
    },
    {
        ...
        implemented: true, profile: 'Full',
        methods: [
            { name: 'Create',        signature: 'Create(lump: CR1 Inform R) → CR0: nullable BankVariable E; DR0: status/error', perms: 'E + M + Inform R', description: 'Validate the complete self-defining LUMP, atomically commit private custody or clean up, then issue the typed capability in CR0. CR0 is NULL on failure; DR0 is diagnostic only.', implemented: true },
