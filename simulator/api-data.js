...
const API_DATA = [
    ...
    },
    {
        ...
        implemented: true, profile: 'Full',
        methods: [
            { name: 'Create',        signature: 'Create(lump: CR1) → variable: CR0, status: DR0', perms: 'E + M + Inform R', description: 'Validate the complete self-defining LUMP before issuing its typed BankVariable E capability in CR0; DR0 is binary status only and never authority.', implemented: true },
            { name: 'Read',          signature: 'Read(variable: CR0, offset: DR1, words: DR2) → readable: CR4, status: DR0', perms: 'BankVariable E', description: 'Copy a bounded slice of a live Bank-managed LUMP through the typed CR0 capability into a fresh readable Inform capability.', implemented: true },
            { name: 'InspectVariable', signature: 'InspectVariable(variable: CR0) → status: DR0; words: DR1; capacity: DR2; issue: DR3; lifecycle: DR4', perms: 'BankVariable E', description: 'Inspect scalar size/capacity/lifecycle fields in distinct DRs using only the typed CR0 capability, without revealing private Namespace storage.', implemented: true },
            { name: 'Release',       signature: 'Release(variable: CR0) → status: DR0', perms: 'BankVariable E', description: 'Zeroize and retire a Bank-managed LUMP through its CR0 capability; CR0 is cleared afterward.', implemented: true },
            { name: 'RevokeVariable', signature: 'RevokeVariable(variable: CR0) → status: DR0', perms: 'BankVariable E', description: 'Revoke the CR0 variable authority and zeroize the private LUMP allocation.', implemented: true },
