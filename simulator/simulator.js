...
class ChurchSimulator {
    ...
    _execEloadcall(d) {
        ...
        // ecMethodIdx=0: fast path — NIA = lump word 1 (pc=0 because fetch is
        // base+1+pc).
        ...
        if (ecMethodIdx === 0) {
            ...
            if (entryOpcode === 23) {
                ...
                // Fast-path entry so the lump still executes. Logical PC 0
                // fetches lump word 1; PC 1 would silently skip it.
                this.pc = 0;
...
ChurchSimulator.FAULT_CODES = {
    ...
    OUTFORM_MINT: 0x17, OUTFORM_HDR: 0x18, IRQ_NULL_BASE: 0x14, OUTFORM_TIMEOUT: 0x19,
