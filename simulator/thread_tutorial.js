class ThreadTutorial {
    ...
    _memMap(highlighted) {
        const sections = [
            ...
            { id: 'cap',   label: '\u2460 Capabilities',     sub: 'GT homes for CR0\u2013CR11  (+244\u2026+255)',            bg: '#3a2c00', border: '#c8a020', text: '#f0d060' },
        ];
...
<p>Reading top-to-bottom: <strong>Header \u2192 Data Registers \u2192 Heap/Freespace \u2192 Stack \u2192 Capabilities</strong>. The canonical Thread is 256 words and its capability zone is <code>+244\u2026+255</code> (CR0\u2013CR11).</p></div>
...
<p>V20 reserves <strong>12 words</strong> at offsets <code>+244\u2026+255</code> as the <strong>GT zone</strong>: one Golden Token home for each of CR0\u2013CR11. CR14 is derived transiently from restored CR0.</p>
