...
#   * Hardware cold-boot catalog has 11 slots (0–10).
#     Slots 0–10 all produce NS entries (slot 8 is bitstreamOnly but still
#     increments nsCount) → nsCount=11.
#   * Step-2 resident lumps for slots ≥11 push nsCount up: nsSlot=18 → nsCount=19.
...
CONFIGS = [
    pytest.param(_cfg_default(),           False, 11, id="default"),
    pytest.param(_cfg_custom_step1(),      False, 11, id="custom_step1"),
    ...
    pytest.param(_cfg_no_window(),         True,  11, id="no_window_bootconfig"),
]
