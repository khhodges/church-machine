...
#   * Hardware cold-boot catalog has 8 slots (0–7).
#     Slots 0–6 and slot 7 (WukongCallHome) all produce NS entries → nsCount=8.
...
CONFIGS = [
    pytest.param(_cfg_default(),           False,  8, id="default"),
    pytest.param(_cfg_custom_step1(),      False,  8, id="custom_step1"),
    ...
    pytest.param(_cfg_no_window(),         True,   8, id="no_window_bootconfig"),
]
